    ...
    >
      <div className="mx-auto flex w-full max-w-[520px] flex-col gap-10 px-6 py-16">
        <div className="flex flex-col gap-4 text-center" data-animate="fade-up">
          ...
          <h2 className="font-[var(--font-crimson),var(--font-nanum),var(--font-gowun),serif] text-[28px] font-semibold text-[var(--text-primary)]">
            {info.title}
          </h2>
        ...
        >
          <div className="grid gap-6 text-[15px] text-[var(--text-primary)]">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[10px] tracking-[0.35em] text-[var(--muted)]">WHERE</span>
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-[var(--accent-strong)]">MAP</span>
            </div>
