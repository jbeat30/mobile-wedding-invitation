...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-[12px] font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-rose)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ring-offset-[var(--bg-primary)]',
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: 'h-10 rounded-md px-6 py-3 text-[14px]',
